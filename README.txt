...
NOTES
    ...
    This program outputs to XDSL format, which is a native format of
    SMILE and GeNIe.  GeNIe can be downloaded free of charge from the
    Decision Systems Laboratory at the University of Pittsburgh, at
    the following URL: http://genie.sis.pitt.edu/
